                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3 mb-lg-0 mt-3">
                                    ...
                                    <input type="datetime-local" readonly="readonly"  class="form-control" name="updated_at" id="datepicker-deadline-input" value="<?php echo date('Y-m-d\TH:i'); ?>" placeholder="Enter Deploy link">
                                </div>
                            </div>
                        </div>
                    </div>
