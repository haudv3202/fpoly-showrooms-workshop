...
<div class="container-fluid">
    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img src="{{asset('theme/admin/assets/images/profile-bg.jpg')}}" alt="" class="profile-wid-img">
        </div>
    </div>
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="{{asset('theme/admin/assets/images/users/avatar-1.jpg')}}" alt="user-img" class="img-thumbnail rounded-circle">
                </div>
            </div>
            <!--end col-->
            <div class="col">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="{{asset('theme/admin/assets/images/users/avatar-5.jpg')}}" alt="" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('theme/admin/assets/images/small/img-4.jpg')}}" alt="" height="50" class="rounded">
                                            </div>
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('theme/admin/assets/images/small/img-5.jpg')}}" alt="" height="50" class="rounded">
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('theme/admin/assets/images/small/img-6.jpg')}}" alt="" height="50" class="rounded">
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                                ...
                                                                <div class="accordion-item border-0">
                                                                    <div class="accordion-header" id="headingThree">
                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapsethree" aria-expanded="false">
                                                                            <div class="d-flex">
                                                                                <div class="flex-shrink-0">
                                                                                    <img src="{{asset('theme/admin/assets/images/users/avatar-5.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                                                                </div>
                                                                                <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <div class="accordion-item border-0">
                                                                    <div class="accordion-header" id="headingFive">
                                                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                                                            <div class="d-flex">
                                                                                <div class="flex-shrink-0">
                                                                                    <img src="{{asset('theme/admin/assets/images/users/avatar-7.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                                                                </div>
                                                                                <div class="flex-grow-1 ms-3">
                                                                                    <h6 class="fs-14 mb-1">
                                                                                        Lewis Arnold
                                                                        ...
                                                                        <div class="accordion-body ms-2 ps-5">
                                                                            ...
                                                                            <div class="avatar-group">
                                                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                                                    <img src="{{asset('theme/admin/assets/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                                                </a>
                                                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                                                    <img src="{{asset('theme/admin/assets/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-xs">
                                                                                </a>
                                                                            ...
                                                                            <div class="row mt-2">
                                                                                <div class="col-xxl-6">
                                                                                    <div class="row border border-dashed gx-2 p-2">
                                                                                        <div class="col-3">
                                                                                            <img src="{{asset('theme/admin/assets/images/small/img-3.jpg')}}" alt="" class="img-fluid rounded">
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{asset('theme/admin/assets/images/small/img-5.jpg')}}" alt="" class="img-fluid rounded">
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{asset('theme/admin/assets/images/small/img-7.jpg')}}" alt="" class="img-fluid rounded">
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{asset('theme/admin/assets/images/small/img-9.jpg')}}" alt="" class="img-fluid rounded">
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                    </div>
                                                                                    <!--end row-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="swiper project-swiper mt-n4 swiper-initialized swiper-horizontal swiper-backface-hidden">
                                            <div class="d-flex justify-content-end gap-2 mb-2">
                                                <div class="slider-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-d10fea62942ff7d9c" aria-disabled="false">
                                                    <div class="avatar-title fs-18 rounded px-1">
                                                        <i class="ri-arrow-left-s-line"></i>
                                                    </div>
                                                </div>
                                                <div class="slider-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-d10fea62942ff7d9c" aria-disabled="false">
                                                    <div class="avatar-title fs-18 rounded px-1">
                                                        <i class="ri-arrow-right-s-line"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-wrapper" id="swiper-wrapper-d10fea62942ff7d9c" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-400px, 0px, 0px);">
                                                <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 5" style="width: 380px; margin-right: 20px;">
                                                ...
                                                <!-- end slide item -->
                                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="2 / 5" style="width: 380px; margin-right: 20px;">
                                                ...
                                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 5" style="width: 380px; margin-right: 20px;">
                                                ...
                                                <div class="swiper-slide" role="group" aria-label="4 / 5" style="width: 380px; margin-right: 20px;">
                                                    <div class="card profile-project-card shadow-none profile-project-danger mb-0">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                ...
                                                <!-- end slide item -->
                                                <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 380px; margin-right: 20px;">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                                                                    <div class="avatar-xs">
                                                                        <img src="{{asset('theme/admin/assets/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle img-fluid">
                                                                    </div>
                                                                </div>
                                                                <div class="avatar-group-item">
                                                                    <div class="avatar-xs">
