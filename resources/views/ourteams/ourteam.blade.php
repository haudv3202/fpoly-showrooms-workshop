                ...
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_1.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-6 col-xl-4 col-lg-6">
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_2.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-6 col-xl-4 col-lg-6">
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_3.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-6 col-xl-4 col-lg-6">
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_4.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-6 col-xl-4 col-lg-6">
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_5.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-6 col-xl-4 col-lg-6">
                <div class="team-wrap">
                    <div class="img">
                        <a href="team-single.html"
                            ><img
                                src="{{asset('images/team/team_img_6.jpg')}}"
                                alt
                        /></a>
                    </div>
                    <div class="content">
