...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
 ...
 <!-- end Dashboard Menu -->
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('contact-list') }}">
                                <i class="ri-pages-line"></i> <span data-key="t-liên-hệ">liên hệ</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('contact-edit') }}">
                                <i class="ri-pages-line"></i> <span data-key="t-liên-hệ">cài đặt liên hệ</span>
                            </a>
                        </li> --}}
                        <li class="nav-item">
    ...
    <script type="text/javascript" src="{{ asset('theme/admin/assets/libs/choices.js/public/assets/scripts/choices.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/admin/assets/libs/flatpickr/flatpickr.min.js') }}"></script>
    ...
    <script src="{{ asset('theme/admin/assets/js/pages/apps-nft-explore.init.js') }}"></script>
    <!-- filepond js -->
    ...
    <!--nft create init js-->
    <script src="{{ asset('theme/admin/assets/js/pages/apps-nft-create.init.js') }}"></script>
    ...
    {{-- our team --}}
    <!-- team init js -->
    <script src="{{ asset('theme/admin/assets/js/pages/team.init.js') }}"></script>
    ...
    <!-- crm leads init -->
    <script src="{{ asset('theme/admin/assets/js/pages/crm-leads.init.js') }}"></script>
